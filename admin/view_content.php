							...
							foreach($get_content as $row){
								?><tr class="gradeX odd">
									...
									<td class="hidden-phone ">
										<!-- Content Type-->
										<img src="<?php echo $row["link_preview"]; ?>" title="<?php echo $row["name"]; ?>" alt="<?php echo $row["name"]; ?>" style="width:80px;height:50px;">
									</td>
									...
									<td class="hidden-phone ">
										<a target="_blank" href="edit_content_panel.php?name=<?php echo $row["name"];?>&ContentId=<?php echo $row["ContentId"];?>&category=<?php echo $row["category"];?>&subcategory=<?php echo $row["subcategory"];?>&status=<?php echo $row["status"];?>&link=<?php echo $row["file_link"];?>" style="color:green;"><i class="icon-edit"></i> Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;										
										<a href="view_content.php?hide=true&ContentId=<?php echo $row["ContentId"];?>&category=<?php echo $row["category"];?>&link=<?php echo $row["file_link"];?>" style="color:blue;" onclick="return confirm('Do you really hide to delete this file?');"><i class="icon-adjust"></i> Hide</a> &nbsp;&nbsp;&nbsp;&nbsp;
										<a href="view_content.php?delete=true&ContentId=<?php echo $row["ContentId"];?>&category=<?php echo$row["category"];?>&link=<?php echo $row["file_link"];?>" style="color:red;" onclick="return confirm('Do you really want to delete this file?');"><i class="icon-trash"></i> Delete</a> &nbsp;&nbsp;&nbsp;&nbsp;
									</td>
								</tr> <?php
							}
						}
